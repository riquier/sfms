import {gitDiffToObjectListProcessor, gitDiffLineToObjectConverter, gitDiffLineValidator} from "../helpers";
...
describe("git diff", () => {
    ...
    describe('gitDiffLineToObjectConverter', () => {
        it('can process a well formated line', () => {
            ...
            expect(output).toHaveProperty('path', 'force-app/main/default/flows/DEX_Circumstances_SCORE_Assessment.flow-meta.xml');
        });
    });
